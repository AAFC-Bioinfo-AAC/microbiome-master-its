...
for i in `ls *.fq`; do echo "Checking fastq file $i for possible errors"; python /fs/isi-nas1/grdi/grdi_eco/groups/phillipsl/tools/miniconda3/envs/valid-fastq/bin/biopet-validatefastq -i $i ; echo "Complete." ;  done 
