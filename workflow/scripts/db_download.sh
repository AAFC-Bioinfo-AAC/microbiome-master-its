...
#echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
#echo ">>>>>>                                                                                   >>>>>>" 
#echo ">>>>>>                          This is Microbiome Master v.0.2                          >>>>>>"
#echo ">>>>>>                                                                                   >>>>>>"                               
#echo ">>>>>>             Developed by the Microbial Ecology Group (AAFC-Harrow)                >>>>>>"  
#echo ">>>>>>            https://bitbucket.org/product NEED TO UPDATE THIS LINK                 >>>>>>"
#echo ">>>>>>                                                                                   >>>>>>"           
#echo ">>>>>> Suggestions or issues should be sent to Brent Seuradge <brent.seuradge@agr.gc.ca> >>>>>>"
#echo ">>>>>>                                                                                   >>>>>>" 
#echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
#echo " " 
